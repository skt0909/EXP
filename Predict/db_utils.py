"""
db_utils.py — shared database helper for Predict.

get_engine() reads DATABASE_URL from the project .env and returns a
SQLAlchemy Engine. Mirrors Data_ingestion/utils/db_utils.py and
Feature_engineering/db_utils.py so every stage points at the same
