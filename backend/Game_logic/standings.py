...
Game_logic/scoring.py's per-user isolation.
...
this repo has no season-length constant anywhere, so
SEASON_LENGTH_GAMEWEEKS = 38 (a real Premier League season) is
hardcoded here purely to know how many gameweek-slots to fill when
generating the schedule upfront. If the round-robin cycle (n-1 rounds
...
SEASON_LENGTH_GAMEWEEKS = 38  # see module docstring
WIN_POINTS = 3
DRAW_POINTS = 1
LOSS_POINTS = 0
BYE_POINTS = 3
